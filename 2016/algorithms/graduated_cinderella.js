...
// Cinderella "effect" wears off as the rounds progress.
// Increase randomness as rounds progress.
function (game, team1, team2) {
  ...
  if (game.round > 0) {
    team1Odds -= Math.random() * (5-game.round)/5;
    team2Odds -= Math.random() * (5-game.round)/5;
  }

  if (team1.seed > 8 && team1CinderellaPoints > 1) {
    team1Odds -= Math.log(team1CinderellaPoints)/(6-game.round);
  }
  if (team2.seed > 8 && team2CinderellaPoints > 1) {
    team2Odds -= Math.log(team2CinderellaPoints)/(6-game.round);
  }
