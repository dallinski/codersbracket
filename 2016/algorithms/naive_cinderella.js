...
// This version of the algorithm is naive. It blindly applies Cinderella points to all seeds, not just 9-seeds and worse.
function (game, team1, team2) {
  ...
  if (Math.random() * Math.log(team1.seed+1) * ((5-team1CinderellaPoints)/5) < Math.random() * Math.log(team2.seed+1) * ((5-team2CinderellaPoints)/5)) {
    team1.winsGame();
  } else {
    team2.winsGame();
  }
